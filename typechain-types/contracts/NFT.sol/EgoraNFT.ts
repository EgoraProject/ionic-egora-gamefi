...
export interface EgoraNFTInterface extends utils.Interface {
  functions: {
    ...
    "updateRoyaltyFee(uint256)": FunctionFragment;
  };
...
export interface EgoraNFT extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: EgoraNFTInterface;
