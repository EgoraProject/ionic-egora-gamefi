...
contract NFTMarketplace is Ownable, ReentrancyGuard {
    INFTFactory private immutable NFTFactory;
    ...
    modifier isNFT(address _nft) {
        require(NFTFactory.isNFT(_nft), "not  NFT");
        _;
    }
    ...
    function listNft(
        ...
        address _payToken,
        uint256 _price
    ) external isNFT(_nft) isPayableToken(_payToken) {
